...
public class RgbColor {
    ...
    private int convertValueTo8Bit(int val) {
        ...
        if (bitDepth < 8) {
            ...
            while (left != 0) {
                ...
                newVal = newVal * IntMath.powerOfTwo(shift) + val /
                        IntMath.powerOfTwo(bitDepth - shift);
                left -= shift;
            }
            return newVal;
        }
    ...
    public String toString() {
        return String.format("RgbColor(%d Bit, %d, %d, %d)", bitDepth, red, green,
                blue);
    }
    @Override
    public boolean equals(Object obj) {
        ...
        return bitDepth == other.bitDepth && blue == other.blue && green ==
                other.green && red == other.red;
    }
    @Override
    public int hashCode() {
